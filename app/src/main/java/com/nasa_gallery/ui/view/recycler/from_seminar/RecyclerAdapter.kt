...
class RecyclerAdapter(
    ...
    class EarthViewHolder(binding: ActivityRecyclerItemEarthBinding):RecyclerView.ViewHolder(binding.root) {

    }
    class MarsViewHolder(binding: ActivityRecyclerItemMarsBinding):RecyclerView.ViewHolder(binding.root) {

    }
}
class HeaderViewHolder(binding: ActivityRecyclerItemHeaderBinding):RecyclerView.ViewHolder(binding.root) {
